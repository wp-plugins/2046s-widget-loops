...
These widgets covers the most routinely used Post and Page content logic. Although the widgets are pretty complex they do not fully cover all the possible layouts.
...
The "Post widget" that let's you display number of posts. You can select what part of the content should be shown, plus you can restrict the loop by some rules.
